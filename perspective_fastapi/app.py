...
description = """
perspective_fastapi API helps you do awesome stuff. 🚀
"""

app = FastAPI(
    title="perspective_fastapi",
    description=description,
    version=read("VERSION"),
    terms_of_service="http://perspective_fastapi.com/terms/",
    contact={
        "name": "RajaPoseidon",
        "url": "http://perspective_fastapi.com/contact/",
        "email": "RajaPoseidon@perspective_fastapi.com",
    },
    license_info={
        "name": "The Unlicense",
