...
# WARNING: Ensure imports from `perspective_fastapi` comes after this line
from perspective_fastapi import app, settings, db  # noqa
from perspective_fastapi.cli import create_user, cli  # noqa
